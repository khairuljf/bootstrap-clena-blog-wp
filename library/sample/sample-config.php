<?php
    ...
    Redux::setSection($opt_name, array(
        'title'=>'Basic Field',
        'id'=>'basic',
        'desc'=>'You can change Basic option for theme',
        'fields'           => array(
            array(
                'id'       => 'logo',
                'type'     => 'media',
                'title'    => __( 'Chnage logo', 'redux-framework-demo' ),
                'url'      => true,
                'desc'     => __( 'Change your logo from here', 'redux-framework-demo' ),
            ...
            array(
                ...
                'id'=>'subtitle',
                'type'=>'text',
                'desc'=>'Change your header Subtitle',
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'fcontent',
                'type'     => 'editor',
                'title'    => __( 'Chnage footer content', 'redux-framework-demo' ),
                'url'      => true,
                'desc'     => __( 'Change your footer content', 'redux-framework-demo' ),
   ...
   Redux::setSection($opt_name, array(
       ...
       'id'=>'social',
       'subsection'=>true,
       'desc'=>'Set your social profile',
       'fields'=>array(
           array(
               'title'=>'twitter',  
               'id'=>'tw',  
               'type'=>'text',  
               'desc'=>'set your twitter profile link'
           ...
           array(
               ...
               'id'=>'fb',  
               'type'=>'text',  
               'desc'=>'set your facebook profile link'
           ...
           array(
               ...
               'id'=>'ld',  
               'type'=>'text',  
               'desc'=>'set your linkedin profile link'
           ...
           array(
               ...
               'id'=>'git',  
               'type'=>'text',  
               'desc'=>'set your github profile link'
